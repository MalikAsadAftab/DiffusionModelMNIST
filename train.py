...
def parse_arguments():
    #Parse and return command-line arguments for training the diffusion model.
    ...
    parser.add_argument("--beta1", type=float, default=0.0001, help="Hyperparameter beta1 for DDPM")
    parser.add_argument("--beta2", type=float, default=0.02, help="Hyperparameter beta2 for DDPM training")
...
if __name__ == "__main__":
    ...
    # Initialize the diffusion model with the parsed arguments
    diffusion_model = DiffusionModel(device=args.device, dataset_name=args.dataset_name, 
                                     checkpoint_name=args.checkpoint_name)
    
    # Train the diffusion model with the specified parameters
